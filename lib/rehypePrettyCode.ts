...
const BLOCK =
  "rounded-lg my-5 overflow-x-auto bg-gray-900 shadow-surface-elevation-low ring-1 ring-rose-100/[3%] ring-inset"
const TITLE =
  "mb-0.5 rounded-md rounded-b-none bg-rose-100/10 px-3 py-2 font-mono text-xs text-rose-100/70 shadow-sm"
