...
export const Button: FC<ButtonProps> = ({ children, className, parentClassName }) => {
  return (
    <button className={`relative inline-block text-sm font-medium text-primary-500 group active:text-primary-500 focus:outline-none focus:ring ${parentClassName}`}>
      <span
